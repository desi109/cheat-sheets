...
![Google Drive Homepage](images/16-design-Google-Drive/figure1-google-drive-homepage.png)

*Figure 1: Google Drive Homepage*

![Google Drive Mobile](images/16-design-Google-Drive/figure2-google-drive-mobile.svg)

*Figure 2: Google Drive Mobile*
...
![File System Hierarchy](images/16-design-Google-Drive/figure3-file-system-hierarchy.svg)
...
![Hard Drive Storage](images/16-design-Google-Drive/figure4-hard-drive-storage.png)

*Figure 4: Hard Drive Storage*
...
![Consistent Hashing](images/16-design-Google-Drive/figure5-consistent-hashing.svg)
...
![Replication Strategies](images/16-design-Google-Drive/figure6-replication-strategies.svg)

*Figure 6: Replication Strategies*
...
![High-Level Architecture](images/16-design-Google-Drive/figure7-high-level-architecture.png)
...
![Synchronization](images/16-design-Google-Drive/figure8-synchronization.svg)
...
![Conflict Resolution](images/16-design-Google-Drive/figure9-conflict-resolution.svg)
...
![Detailed Architecture](images/16-design-Google-Drive/figure10-detailed-architecture.png)
...
1. **Delta sync.** When a file is modified, only modified blocks are synced instead of the whole file using a sync algorithm [7] [8].
2. **Compression.** Applying compression on blocks can significantly reduce the data size. Thus, blocks are compressed using compression algorithms depending on file types. For example, gzip and bzip2 are used to compress text files. Different compression algorithms are needed to compress images and videos.
...
![Block Storage](images/16-design-Google-Drive/figure11-block-storage.png)

*Figure 11: Block Storage*
...
![Incremental Sync](images/16-design-Google-Drive/figure12-incremental-sync.svg)

*Figure 12: Incremental Sync*
...
![Database Schema](images/16-design-Google-Drive/figure13-database-schema.svg)
...
![Upload Sequence](images/16-design-Google-Drive/figure14-upload-sequence.svg)

*Figure 14: Upload Sequence*
...
![Download Sequence](images/16-design-Google-Drive/figure15-download-sequence.svg)

*Figure 15: Download Sequence*
...
1. Communication for notification service is not bi-directional. The server sends information about file changes to the client, but not vice versa.
2. WebSocket is suited for real-time bi-directional communication such as a chat app. For Google Drive, notifications are sent infrequently with no burst of data.
...
1. **De-duplicate data blocks.** Eliminating redundant blocks at the account level is an easy way to save space. Two blocks are identical if they have the same hash value.
...
3. **Moving infrequently used data to cold storage.** Cold data is the data that has not been active for months or years. Cold storage like Amazon S3 glacier [11] is much cheaper than S3.
